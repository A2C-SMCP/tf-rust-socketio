[![Latest Version](https://img.shields.io/crates/v/tf_rust_engineio)](https://crates.io/crates/tf_rust_engineio)
[![docs.rs](https://docs.rs/tf_rust_engineio/badge.svg)](https://docs.rs/tf_rust_engineio)
...
``` rust
use tf_rust_engineio::{ClientBuilder, Client, packet::{Packet, PacketId}};
use url::Url;
use bytes::Bytes;
...
Documentation of this crate can be found up on [docs.rs](https://docs.rs/tf_rust_engineio).
...
```toml
[dependencies]
tf-rust-engineio = { version = "0.6.1", features = ["async"] }
```
